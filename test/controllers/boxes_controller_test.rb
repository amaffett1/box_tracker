...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference("Box.count") do
      post boxes_url, params: { box: { code: @box.code, description: @box.description, location: @box.location, name: @box.name, user_id: @box.user_id } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { code: @box.code, description: @box.description, location: @box.location, name: @box.name, user_id: @box.user_id } }
